...
pub trait Node: Drop {
    ...
    fn init_child(&mut self, _f: Box<dyn FnOnce() -> AsyncNode>, parent_container: gtk::Container) -> (AsyncNode, bool);
    fn init_sibling(&mut self, _f: Box<dyn FnOnce() -> AsyncNode>, _parent_container: gtk::Container) -> (AsyncNode, bool);
